...
Backend-focused engineer with ~3 years of experience building production web
applications. Strong background in **TypeScript** (NestJS / Angular), now going
deeper into **.NET** and **Go**.

I care about clean architecture, well-modeled domains, and code that stays easy
